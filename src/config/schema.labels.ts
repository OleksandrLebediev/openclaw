...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.defaults.personaMode": "Persona Mode",
  ...
  "agents.defaults.availability": "Agent Availability",
  "agents.defaults.availability.timezone": "Agent Timezone",
  "agents.defaults.availability.inactiveHours": "Inactive windows",
  "agents.defaults.availability.inactiveHours.start": "Inactive Hours Start",
  "agents.defaults.availability.inactiveHours.end": "Inactive Hours End",
  "agents.defaults.availability.inactiveHours.days": "Inactive Days",
  "agents.defaults.availability.activeHours": "Active Hours",
  "agents.defaults.availability.activeHours.start": "Active Hours Start",
  "agents.defaults.availability.activeHours.end": "Active Hours End",
  "agents.defaults.availability.activeHours.days": "Active Days",
  "agents.defaults.availability.busyWindows": "Busy Windows",
  "agents.defaults.availability.offlineMode": "Offline Mode",
  "agents.defaults.availability.busyDelay": "Busy Window Delay",
  "agents.defaults.availability.busyDelay.minMs": "Busy Delay Min (ms)",
  "agents.defaults.availability.busyDelay.maxMs": "Busy Delay Max (ms)",
  "agents.defaults.availability.randomDelay": "Extra Random Delay",
  "agents.defaults.availability.randomDelay.minMs": "Random Delay Min (ms)",
  "agents.defaults.availability.randomDelay.maxMs": "Random Delay Max (ms)",
  "agents.defaults.availability.readingSpeed": "Reading Speed",
  "agents.defaults.availability.readingSpeed.wpm": "Reading Speed (wpm)",
  "agents.defaults.availability.readingSpeed.minMs": "Reading Delay Min (ms)",
  "agents.defaults.availability.readingSpeed.maxMs": "Reading Delay Max (ms)",
  "agents.defaults.availability.writingSpeed": "Writing Speed",
  "agents.defaults.availability.writingSpeed.wpm": "Writing Speed (wpm)",
  "agents.defaults.availability.writingSpeed.minMs": "Writing Delay Min (ms)",
  "agents.defaults.availability.writingSpeed.maxMs": "Writing Delay Max (ms)",
  "agents.list[].availability": "Agent Availability",
  "agents.list[].availability.timezone": "Agent Timezone",
  "agents.list[].availability.inactiveHours": "Inactive windows",
  "agents.list[].availability.inactiveHours.start": "Inactive Hours Start",
  "agents.list[].availability.inactiveHours.end": "Inactive Hours End",
  "agents.list[].availability.inactiveHours.days": "Inactive Days",
  "agents.list[].availability.activeHours": "Active Hours",
  "agents.list[].availability.activeHours.start": "Active Hours Start",
  "agents.list[].availability.activeHours.end": "Active Hours End",
  "agents.list[].availability.activeHours.days": "Active Days",
  "agents.list[].availability.busyWindows": "Busy Windows",
  "agents.list[].availability.offlineMode": "Offline Mode",
  "agents.list[].availability.busyDelay": "Busy Window Delay",
  "agents.list[].availability.busyDelay.minMs": "Busy Delay Min (ms)",
  "agents.list[].availability.busyDelay.maxMs": "Busy Delay Max (ms)",
  "agents.list[].availability.randomDelay": "Extra Random Delay",
  "agents.list[].availability.randomDelay.minMs": "Random Delay Min (ms)",
  "agents.list[].availability.randomDelay.maxMs": "Random Delay Max (ms)",
  "agents.list[].availability.readingSpeed": "Reading Speed",
  "agents.list[].availability.readingSpeed.wpm": "Reading Speed (wpm)",
  "agents.list[].availability.readingSpeed.minMs": "Reading Delay Min (ms)",
  "agents.list[].availability.readingSpeed.maxMs": "Reading Delay Max (ms)",
  "agents.list[].availability.writingSpeed": "Writing Speed",
  "agents.list[].availability.writingSpeed.wpm": "Writing Speed (wpm)",
  "agents.list[].availability.writingSpeed.minMs": "Writing Delay Min (ms)",
  "agents.list[].availability.writingSpeed.maxMs": "Writing Delay Max (ms)",
