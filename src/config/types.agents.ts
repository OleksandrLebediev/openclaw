...
import type { AgentAvailabilityConfig, HumanDelayConfig, IdentityConfig } from "./types.base.js";
...
export type AgentConfig = {
  ...
  /** Per-agent availability schedule override (active hours, busy windows, reading pace). */
